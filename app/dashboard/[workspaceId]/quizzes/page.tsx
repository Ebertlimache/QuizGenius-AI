              ...
              <Card key={quiz.id} className="border-orange-200 bg-orange-50">
                ...
                <CardFooter>
                  <Button className="w-full" asChild>
                    <Link href={`/dashboard/${workspaceId}/quizzes/${quiz.id}`}>Comenzar cuestionario</Link>
                  </Button>
                </CardFooter>
              </Card>
            ))}
            ...
            <Card key={quiz.id}>
              ...
              <CardFooter className="flex gap-2">
                <Button variant="outline" className="flex-1" asChild>
                  <Link href={`/dashboard/${workspaceId}/quizzes/${quiz.id}/results`}>Ver resultados</Link>
                </Button>
                <Button variant="outline" className="flex-1" asChild>
                  <Link href={`/dashboard/${workspaceId}/quizzes/${quiz.id}`}>Repetir</Link>
                </Button>
              </CardFooter>
            </Card>
          ))}
